...
build:
    ...
    @echo ""
    @echo "Binary:"
    @ls -lh target/release/youtube-cli
...
build-arm:
    ...
    @echo ""
    @echo "Binary:"
    @ls -lh target/aarch64-apple-darwin/release/youtube-cli
...
build-intel:
    ...
    @echo ""
    @echo "Binary:"
    @ls -lh target/x86_64-apple-darwin/release/youtube-cli
...
build-linux-x64:
    ...
    @echo ""
    @echo "Binary:"
    @ls -lh target/x86_64-unknown-linux-musl/release/youtube-cli
...
build-linux-arm:
    ...
    @echo ""
    @echo "Binary:"
    @ls -lh target/aarch64-unknown-linux-musl/release/youtube-cli
...
build-windows:
    ...
    @echo ""
    @echo "Binary:"
    @ls -lh target/x86_64-pc-windows-gnu/release/youtube-cli.exe
...
release-all: setup build-arm build-intel build-linux-x64 build-linux-arm build-windows
    ...
    RELEASE_DIR="release"; \
    mkdir -p "$RELEASE_DIR"; \
    cp target/aarch64-apple-darwin/release/youtube-cli "$RELEASE_DIR/youtube-cli-$VERSION-aarch64-apple-darwin"; \
    cp target/x86_64-apple-darwin/release/youtube-cli "$RELEASE_DIR/youtube-cli-$VERSION-x86_64-apple-darwin"; \
    cp target/x86_64-unknown-linux-musl/release/youtube-cli "$RELEASE_DIR/youtube-cli-$VERSION-x86_64-unknown-linux-musl"; \
    cp target/aarch64-unknown-linux-musl/release/youtube-cli "$RELEASE_DIR/youtube-cli-$VERSION-aarch64-unknown-linux-musl"; \
    cp target/x86_64-pc-windows-gnu/release/youtube-cli.exe "$RELEASE_DIR/youtube-cli-$VERSION-x86_64-pc-windows-gnu.exe"; \
    echo ""; \
